...
export function createPlayer(currentSkinValue, currentHatValue) {
...
export function cleanupMedievalFlowers(medievalFlowers) {
...
export function createMedievalFlowers(scene, medievalFlowers) {
...
export function disposeHierarchy(array, scene) {
  if (!array) return;
  array.forEach(item => {
    scene.remove(item);
    item.traverse(child => {
