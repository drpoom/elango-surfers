...
- Name: cobblestone-regression.spec.ts >> Cobblestone Road Regression Test >> game restarts without crashing
- Location: tests/cobblestone-regression.spec.ts:75:3
...
```
Error: keyboard.press: Test timeout of 60000ms exceeded.
```
