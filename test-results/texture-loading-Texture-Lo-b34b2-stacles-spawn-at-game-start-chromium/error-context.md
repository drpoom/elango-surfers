...
- Name: texture-loading.spec.ts >> Texture Loading >> obstacles spawn at game start
- Location: tests/texture-loading.spec.ts:21:3
...
- generic [ref=e3]:
  - generic:
    - img "Elango Surfers"
    - generic:
      - generic: Elango Surfers v5.2.0
      - generic: Press any key / Tap to start
  - generic:
    - generic: v5.2.0
    - generic: "Score: 2338"
