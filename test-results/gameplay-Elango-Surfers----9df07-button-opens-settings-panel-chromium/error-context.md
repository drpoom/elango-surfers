...
- Name: gameplay.spec.ts >> Elango Surfers - Gameplay Tests >> settings button opens settings panel
- Location: tests/gameplay.spec.ts:65:3
...
```
Error: page.content: Test timeout of 60000ms exceeded.
```
